...
<div class="layout">
    ...
    <main class="main">
        <div class="topbar">
            <div><div class="page-eyebrow">Produk UMKM</div><h1 class="page-title">Tambah Produk</h1></div>
            <a href="{{ route('products.index') }}" class="btn-back">Kembali</a>
        </div>

        <div class="form-card">
            <div class="form-card-head">
                <div style="font-size:15px;font-weight:700;color:var(--ink);">Form Produk Baru</div>
                <div style="font-size:12.5px;color:var(--muted);margin-top:4px;">Isi data produk secara lengkap agar mudah dikelola.</div>
            </div>
            <div class="form-card-body">
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="nama_produk" name="nama_produk" value="{{ old('nama_produk') }}" class="form-control @error('nama_produk') is-invalid @enderror" maxlength="255" required placeholder="Contoh: Wedang Jahe instan 200 g">
