    ...
    <main class="main">
        <div class="topbar">
            <div>
                ...
                <h1 class="page-title">Tambah Anggota UMKM</h1>
            </div>
            <div>
        ...
        <div class="form-card">
            <div class="form-card-head">
                <div style="font-size:15px;font-weight:700;color:var(--ink);">Form Data Anggota</div>
                <div class="form-hint">Lengkapi data karyawan/anggota UMKM.</div>
            </div>
            ...
            <div class="form-card-body">
                <form action="{{ route('members.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat_karyawan" id="alamat_karyawan" class="form-control @error('alamat_karyawan') is-invalid @enderror" rows="3" required>{{ old('alamat_karyawan') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="telepon_karyawan" id="telepon_karyawan" class="form-control @error('telepon_karyawan') is-invalid @enderror" value="{{ old('telepon_karyawan') }}" required>
