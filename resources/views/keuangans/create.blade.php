    ...
    <main class="main">
        ...
        <div class="form-card">
            <div class="form-card-head">
                <div style="font-size:15px;font-weight:700;color:var(--ink);">Form Keuangan</div>
                <div style="font-size:12.5px;color:var(--muted);margin-top:4px;">Tambahkan transaksi pemasukan atau pengeluaran baru.</div>
            </div>
            <div class="form-card-body">
                <form action="{{ route('keuangans.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="jumlah" id="jumlah" class="form-control @error('jumlah') is-invalid @enderror" value="{{ old('jumlah') }}" min="0" required>
